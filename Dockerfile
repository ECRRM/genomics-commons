...
RUN cd $SETUPDIR/ && \
    ...
    echo "echo 'Welcome to ECRRM Genomics Commons (v1.0)'" >> $SETUPDIR/init.sh && \
    echo "echo '****************************************'" >> $SETUPDIR/init.sh && \
    echo "echo 'ECRRM Genomics Commons is a docker image for genomics tools'" >> $SETUPDIR/init.sh && \
    echo "echo " >> $SETUPDIR/init.sh && \
